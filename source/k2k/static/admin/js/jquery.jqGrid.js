...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(dir==="rtl") { pgl += str; }
			if(ts.p.pginput===true) { pginp= "<td dir='"+dir+"'><span class='ui-pg-span'>"+$.jgrid.format(ts.p.pgtext || "","</span><input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/><span class='ui-pg-span'>","</span><span id='sp_1_"+$.jgrid.jqID(pgid)+"'></span>")+"</td>";}
			if(ts.p.pgbuttons===true) {
		...
		var arf = ts.p.hidegrid===false ? $("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' />").hover(
